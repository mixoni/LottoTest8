...
var Scene = __webpack_require__(/*! ./components/Scene */ "./components/Scene.jsx");
var ReactCountdownClock = __webpack_require__(/*! react-countdown-clock */ "./node_modules/react-countdown-clock/build/react-countdown-clock.js");
...
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var ReactDOM = __webpack_require__(/*! react-dom */ "./node_modules/react-dom/index.js");
var LuckyNumber = __webpack_require__(/*! ./LuckyNumber */ "./components/LuckyNumber.jsx");
var Circle = /** @class */ (function (_super) {
    ...
    function Circle(props) {
        ...
        _this.Loop = function (move) {
            var ballSelector = document.getElementsByClassName('ball-circle');
            var x, y;
            var _loop_1 = function () {
                var circle = ballSelector[i];
                var mainState = _this;
                var currentLeft = parseFloat(circle.style.left, 10);
                var currentTop = parseFloat(circle.style.top, 10);
                var prevAngle = _this.state.angles[i] - _this.state.spc;
                var currenctAngle = _this.state.angles[i];
                ...
                x = _this.state.cx + _this.state.radius * Math.cos(_this.state.angle * _this.state.deg2rad);
                y = _this.state.cy + _this.state.radius * Math.sin(_this.state.angle * _this.state.deg2rad);
                var nextLeft = x - _this.state.radiusSat;
                var nextTop = y - _this.state.radiusSat;
                var newAngles = _this.state.angles.slice(); //copy the array
                newAngles[i] = _this.state.angles[i] + 18; //this.state.spc; //execute the manipulations
                _this.setState(function (prevState, props) { return ({
                    angles: newAngles
                }); });
                //console.log("this.state.angle: " + this.state.angle);
                if (move) {
                    var moveSlowly_1 = setInterval(function () {
                        prevAngle++;
                        var x = mainState.state.cx + mainState.state.radius * Math.cos(prevAngle * mainState.state.deg2rad);
                        var y = mainState.state.cy + mainState.state.radius * Math.sin(prevAngle * mainState.state.deg2rad);
                        var nextLeft = x - mainState.state.radiusSat;
                        var nextTop = y - mainState.state.radiusSat;
                        //console.log("prevAngle: " + prevAngle + "currenctAngle: " + currenctAngle);
                        //--- when movement ends, stop interval
                        if (prevAngle == currenctAngle) {
                            clearInterval(moveSlowly_1);
                        }
                        else {
        ...
        _this.Animation = function () {
            ...
            _this.setState({ angles: newAngles }, function () {
            });
    ...
    Circle.prototype.render = function () {
        ...
        var idPrefix = this.props.id;
        var className = this.props.className;
        var badge = this.state.dataBadge;
        var numberValue = this.state.numberValue;
        var animation = this.props.animation;
        if (this.props.list.length === 0) {
            return React.createElement("h1", null, "There are no list items");
        }
        else {
            return (React.createElement("div", null, this.state.listItems.map(function (listValue, index) {
                id = idPrefix + "-" + index;
                var inputId = "input-" + idPrefix + "-" + index;
                var inputClassName = "input-" + className;
                return React.createElement("div", { key: index, className: className, "data-badge": badge, id: id },
                    React.createElement(LuckyNumber, { animation: animation, inputClassName: inputClassName, luckyNumberValue: listValue }));
            })));
        }
    };
    return Circle;
...
var CountDownTimer = /** @class */ (function (_super) {
    ...
    function CountDownTimer(props) {
        var _this = _super.call(this, props) || this;
        _this.secondsToTime = function (secs) {
        ...
        _this.countDown = function () {
            ...
            var seconds = _this.state.seconds - 1;
            _this.setState({
                time: _this.secondsToTime(seconds),
                seconds: seconds,
            });
            // Check if we're at zero.
            if (seconds == 5) {
                clearInterval(_this.timer);
                _this.props.onTimerExpired();
            }
        };
        _this.state = { time: {}, seconds: _this.props.seconds };
        _this.timer = 0;
    ...
    CountDownTimer.prototype.render = function () {
        return (React.createElement("div", { className: 'countdown-timer' },
            this.state.time.m,
            ":",
            this.state.time.s));
    };
...
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var ReactDOM = __webpack_require__(/*! react-dom */ "./node_modules/react-dom/index.js");
var LuckyNumber = /** @class */ (function (_super) {
    __extends(LuckyNumber, _super);
    function LuckyNumber(props) {
        ...
        _this.state = { component: React.createElement("div", null,
                React.createElement("input", { type: "hidden", value: "", className: _this.props.inputClassName })) };
        return _this;
    }
    LuckyNumber.prototype.componentDidMount = function () {
        ...
        if (this.props.luckyNumberValue && this.props.luckyNumberValue != 0 && !this.props.animation) {
            ...
            this.setState({ component: React.createElement("div", { className: $class },
                    React.createElement("div", { className: 'ball-inner-circle' },
                        React.createElement("div", { className: 'ball-circle-number' },
                            React.createElement("span", null, this.props.luckyNumberValue))))
            });
        }
    };
    LuckyNumber.prototype.render = function () {
        return (React.createElement("div", null,
            " ",
    ...
    Results.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("div", { className: "row row-3-custom" },
                ...
                React.createElement("div", { className: "col-md-9 results-numbers" },
                    React.createElement("div", null,
                        this.state.listItems3.map(function (value, i) { return React.createElement(Circle, { list: [value], dataBadge: i + 1, className: "ball-numbers-medium", key: i }); }),
                        " ")))));
    };
    return Results;
}(React.Component));
...
var Scene = /** @class */ (function (_super) {
    ...
    function Scene(props) {
        var _this = _super.call(this, props) || this;
        _this.RenderCountdownScene = function () {
        ...
        _this.RenderAnimationScene = function () {
            ...
            fetch("api/GetNumbers")
                ...
                _this.setState({ component: React.createElement(Animation, { numbers: result.numbers, onComplete: _this.RenderLastThreeResultsScene, onTimerExpired: _this.RenderCountdownScene }) });
            }, function (error) {
                console.log(error);
            });
        };
